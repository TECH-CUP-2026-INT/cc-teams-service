...
- **Repository:** [cc-teams-service](https://github.com/TECH-CUP-2026-INT/cc-teams-service)
- **Related services:** `cc-identity-service` (authentication), `mk-tournament-service`, `users-players-service`

## Contribution conventions

- Work branches: `feat/**` into `develop`; `develop`/`feat/**` into `main`
  via pull request.
- Every change goes through the CI pipeline (build, tests, coverage) before
  it can be merged — see [Configuration](configuracion.md).
